"""
The following code was lightly adapted from 
    ...
    for model1 in forecasts.columns:
        for model2 in forecasts.columns:
            ...
            if model1 == model2:
                ...
                length_real=len(real_price.index)
                p_values.loc[model1, model2] = DM(p_real=real_price.values.reshape(-1, length_real), 
                                                  p_pred_1=forecasts.loc[:, model1].values.reshape(-1, length_real), 
                                                  p_pred_2=forecasts.loc[:, model2].values.reshape(-1, length_real), 
    ...
    for model1 in forecasts.columns:
        for model2 in forecasts.columns:
            ...
            if model1 == model2:
                ...
                length_real=len(real_price.index)
                p_values.loc[model1, model2] = GW(p_real=real_price.values.reshape(-1, length_real), 
                                                  p_pred_1=forecasts.loc[:, model1].values.reshape(-1, length_real), 
                                                  p_pred_2=forecasts.loc[:, model2].values.reshape(-1, length_real), 
                                                  norm=norm, version='multivariate')
